...
- If you use the contact form, your name, email address, and message are submitted through Formspree so I can respond to your inquiry.
...
- A self-hosted engagement API may process limited technical request data to store post visit and reaction counts.
